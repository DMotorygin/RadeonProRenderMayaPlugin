...
#pragma warning(pop)
	...
	public:
		...
		void SetAdaptiveSubdivisionFactor(float adaptiveFactor, float height, rpr_camera camera, rpr_framebuffer frameBuf);
...
#define SHOW_EXTENDED_ERROR_MSG
	...
	inline void Shape::SetAdaptiveSubdivisionFactor(float adaptiveFactor, float image_height, rpr_camera camera, rpr_framebuffer frameBuf)
	{
		...
		res = rprShapeSetSubdivisionAutoRatioCap(Handle(), autoRatioCap);
